...
fm25c64 is a 64Kbit Ferroelectric Nonvolatile RAM IC with SPI interface which performs write operations at bus speed.

This example does 2 writes to a FRAM memory connected to SPI2 port (PB12 - PB15 pins) with a dump after each write.
...
In this example UART2 is set to 115200 bps. The CPU is clocked by 16 MHz external crystal oscillator.

Cheaper fm25c16 IC can be used without any modifications in a source code.
