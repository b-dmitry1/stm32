...
for %%f in (!c!) do (
  ...
  -DSTM32F10X_CL -DSTM32F1XX -DHSE_VALUE=16000000 -Wall ^
  %%f -o bin\%%~nf.o
...
for %%f in (!cpp!) do (
  arm-none-eabi-g++ -x none -mcpu=cortex-m3 -mthumb -mfloat-abi=soft -fsigned-char -O2 -ffunction-sections -fdata-sections -fno-exceptions -fno-rtti -mlittle-endian ^
  -I. -I.. -I..\inc -T..\memory.ld -g -lm -nostartfiles -c ^
  -DSTM32F10X_CL -DSTM32F1XX -DHSE_VALUE=16000000 -Wall ^
  %%f -o bin\%%~nf.o
...
-DSTM32F10X_CL -DSTM32F1XX -DHSE_VALUE=16000000 -Wall -o bin\a.out ^
!obj!
