...
for %%f in (!c!) do (
  ...
  -I. -I.. -I..\..\inc -I..\..\inc\stm32f4xx -T..\..\libstm32f4xx\stm32f407.ld -g -lm -nostartfiles -c ^
  -DSTM32F40_41xxx -DSTM32F4XX -Wall ^
  %%f -o bin\%%~nf.o
...
-T..\..\libstm32f4xx\stm32f407.ld -g -lm -nostartfiles -Wl,-Map,bin\build.map ^
-DSTM32F40_41xxx -DSTM32F4XX-Wall -o bin\a.out ^
!obj!
