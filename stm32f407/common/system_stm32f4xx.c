...
// PLLSAIR output (LTDC) = VCO output / PLL_R
// PLLSAIR output: 96 MHz
// PLL_R: 2..7
// 360 Mhz / 7 = 51.42 MHz
#define PLLSAI_R	7

// PLLSAIP output = VCO output / PLL_P
// PLLSAIP output: 48 MHz
// PLLSAI_P: 0 - 2, 1 - 4, 2 - 6, 3 - 8
// 384 Mhz / 8 = 48 MHz
#define PLLSAI_P	3
...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
	...
	// PLLSAI
	RCC->PLLSAICFGR = (/*PLL_N*/ 350 << 6ul) | (PLLSAI_P << 16ul) | (PLLSAI_R << 28ul);
