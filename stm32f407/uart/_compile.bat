...
for %%f in (!c!) do (
  ...
  -I. -I.. -I..\inc -T..\memory.ld -g -O2 -lm -nostartfiles -c ^
  -DSTM32F40_41xxx -DSTM32F4XX -DHSE_VALUE=16000000 -Wall ^
  %%f -o bin\%%~nf.o
...
-T..\memory.ld -g -lm -nostartfiles -Wl,-Map,bin\build.map ^
  -DSTM32F40_41xxx -DSTM32F4XX -DHSE_VALUE=16000000 -Wall -o bin\a.out ^
!obj!
